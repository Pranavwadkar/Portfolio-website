...
<body>
    ...
    <nav class="navbar  navbar-expand-md navbar-light bg-light">
        <a href="#" class="navbar-brand">
            <img src="Photo12.png" height="60" alt="Logo";  >
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ml-auto" >
                ...
                style=" font-size: larger;color: rgb(0,128, 255);">Music</a>
            </div>
    ...
    <div style="background-image: linear-gradient(#bbe9a8,#62c439);">
    <br>
            <br>
            <br>
            <br>
...
.button5 {background-color: #555555;} /* Black */
        ...
        <section id="about" class="about">
            ...
            <button class="button button4" onclick="document.getElementById('about').style.color = 'gray'"></button>
                ...
                <div class="section-title" data-aos="fade-right" >
                    <h2>About</h2>
                    <p style="background-image: linear-gradient(#bbe9a8,#62c439);"><?=$data['shortdesc']?></p>
                </div>
        ...
        <section id="skills" class="skills section-bg">
            <div class="col-md-6 ml-auto" data-aos="fade-left">
                ...
                <div class="row skills-content" style="background-image: linear-gradient(#bbe9a8,#62c439);">
    ...
    ?>
        ...
        <section id="resume" class="resume">
            <div class="col-md-6 mr-auto" data-aos="fade-right" >
                ...
                <div class="row" style="background-image: linear-gradient(#bbe9a8,#62c439);">
                    <div class="col-lg-6" >
...
while($data4=mysqli_fetch_array($runquery4)){
    ...
    <link href="//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css" rel="stylesheet" id="style.css">
...
<div class="container">
    ...
    <br>
        ...
        <section id="skills" class="skills section-bg">
            <div class="col-md-6 mx-auto" data-aos="flip-right">
            ...
            <div class="container" >
                ...
                <div class="row" data-aos="fade-in" >
                    ...
                    <div class="col-lg-5 d-flex align-items-stretch">
                        <div class="info" style="background-image: linear-gradient(#bbe9a8,#62c439);">
                            <div class="address">
    ...
    if (str.length == 0) {
        ...
        xmlhttp.send();
                    ...
                    <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch" >
                        <form action="include/message.php" method="post" role="form" class="php-email-form" style="background-image: linear-gradient(#bbe9a8,#62c439);">
                            <div class="form-row">
